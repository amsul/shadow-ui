...
- Use the Semantic Versioning guide, as mentioned in the [readme file](https://github.com/amsul/pick.js/blob/0.3.0/README.md), in the case that a version bump is due.
