...
- Use the Semantic Versioning guide, as mentioned in the [readme file](https://github.com/amsul/shadow-ui/blob/0.4.0/README.md), in the case that a version bump is due.
